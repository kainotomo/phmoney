...
class EntryRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'i_acct' => ['nullable', 'exists:Kainotomo\Models\Account,guid'],
            ...
            'invoice' => ['nullable', 'exists:Kainotomo\Models\Invoice,guid'],
            ...
            'i_taxtable' => ['nullable', 'exists:Kainotomo\Models\Taxtable,guid'],
            'b_acct' => ['nullable', 'exists:Kainotomo\Models\Account,guid'],
            'b_price_num' => ['nullable', 'integer'],
            'b_price_denom' => ['nullable', 'integer'],
            'bill' => ['nullable', 'exists:Kainotomo\Models\Bill,guid'],
            'b_taxable' => ['nullable', 'boolean'],
            'b_taxincluded' => ['nullable', 'boolean'],
            'b_taxtable' => ['nullable', 'exists:Kainotomo\Models\Taxtable,guid'],
