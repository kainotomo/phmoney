...
class EntryRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'i_acct' => ['nullable', 'exists:App\Models\Portfolio\Account,guid'],
            ...
            'invoice' => ['nullable', 'exists:App\Models\Portfolio\Invoice,guid'],
            ...
            'i_taxtable' => ['nullable', 'exists:App\Models\Portfolio\Taxtable,guid'],
            'b_acct' => ['nullable', 'exists:App\Models\Portfolio\Account,guid'],
            'b_price_num' => ['nullable', 'integer'],
            'b_price_denom' => ['nullable', 'integer'],
            'bill' => ['nullable', 'exists:App\Models\Portfolio\Bill,guid'],
            'b_taxable' => ['nullable', 'boolean'],
            'b_taxincluded' => ['nullable', 'boolean'],
            'b_taxtable' => ['nullable', 'exists:App\Models\Portfolio\Taxtable,guid'],
