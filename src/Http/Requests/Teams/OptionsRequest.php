...
class OptionsRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'options.business.default_customer_taxtable.guid' => ['nullable', 'exists:Kainotomo\Models\Taxtable,guid'],
            'options.business.default_vendor_taxtable.guid' => ['nullable', 'exists:Kainotomo\Models\Taxtable,guid'],
            'options.tax' => ['array'],
